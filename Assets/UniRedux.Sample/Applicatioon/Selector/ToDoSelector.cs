...
namespace UniRedux.Sample.Application
{
    public static class ToDoSelector
    {
        ...
        private static FilterToDoSubject FilterToDoSelector
        {
            get
            {
                if (_filterToDoSelector != null) return _filterToDoSelector;
                _filterToDoSelector = new FilterToDoSubject();
                ToDoApplication.CurrentStore.Subscribe(_filterToDoSelector);
                return _filterToDoSelector;
            }
        }

        public static IObservable<ToDo[]> FilterToDos() => FilterToDoSelector;

        public static IObservable<ToDo> FilterToDoElements(int toDoId)
            => FilterToDoElementSelector(toDoId);
        ...
        private static FilterToDoElementSubject FilterToDoElementSelector(int toDoId)
        {
            ...
            FilterToDoSelector.Subscribe(filterToDoElementSelector);
            return filterToDoElementSelector;
        }
