...
namespace UniReduxEditor.Sample.ScriptableStore
{
    public class StateTreeDisplay : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            using (new EditorGUILayout.HorizontalScope(EditorStyles.toolbar))
            {
                ...
                _scriptableObject = EditorGUILayout.ObjectField(_scriptableObject, typeof(ScriptableObject), true, GUILayout.Width(150)) as ScriptableObject;
