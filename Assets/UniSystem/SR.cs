...
#else
        internal static string ArrayInitializedStateNotEqual {
              get { return SR.GetResourceString("ArrayInitializedStateNotEqual", @"Object is not an array with the same initialization state as the array to compare it to."); }
        }
        internal static string ArrayLengthsNotEqual {
              get { return SR.GetResourceString("ArrayLengthsNotEqual", @"Object is not an array with the same number of elements as the array to compare it to."); }
        }
        internal static string CannotFindOldValue {
